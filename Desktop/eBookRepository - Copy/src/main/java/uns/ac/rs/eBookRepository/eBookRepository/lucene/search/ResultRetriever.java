package uns.ac.rs.eBookRepository.eBookRepository.lucene.search;
...
import uns.ac.rs.eBookRepository.eBookRepository.lucene.indexing.handlers.DocumentHandler;
import uns.ac.rs.eBookRepository.eBookRepository.lucene.indexing.handlers.PDFHandler;
...
//                Integer year = Integer.parseInt(doc.get("year").trim());
                ...
                rd = new ResultData(title, keywords,author,MIME, location,
                        highlight);
                results.add(rd);
            }
            reader.close();
